(function () {
  ...
  angular
    ...
    .factory('horizon.dashboard.esi.lessee.nodes.manage-floating-ips.workflow', manageFloatingIPsWorkflow);

  manageFloatingIPsWorkflow.$inject = [
    'horizon.dashboard.esi.lessee.nodes.manage-floating-ips.basePath',
