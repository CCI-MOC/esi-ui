(function() {
  ...
  angular
    .module('horizon.dashboard.esi.lessee.offers', [
      'horizon.dashboard.esi.lessee.offers.claim',
    ])
    .config(config);
  ...
  function config($provide, $windowProvider) {
    var basePath = $windowProvider.$get().STATIC_URL + 'dashboard/esi/lessee/offers/';
    $provide.constant('horizon.dashboard.esi.lessee.offers.basePath', basePath);

    $provide.constant('horizon.dashboard.esi.lessee.offers.offerConfig', {
      selectAll: true,
      expand: true,
      trackId: 'uuid',
      columns: [
    ...
    $provide.constant('horizon.dashboard.esi.lessee.offers.offerFilterFacets', [
      {
